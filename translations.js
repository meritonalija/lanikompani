...
const translations = {
  sq: {
    ...
    form_notes_lbl: "Përshkrimi i Kërkesës (Dimensionet / sasia)",
    form_notes_ph: "Përshkruani përmasat ose numrin e dritareve/dyerve që kërkoni...",
  ...
  en: {
    ...
    form_notes_lbl: "Project Details (Dimensions / Quantity)",
    form_notes_ph: "Describe dimensions, quantity or specific requirements...",
